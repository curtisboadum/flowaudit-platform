...
/**
 * @file web-design-content.tsx
 * @description Web design landing content — hero, process, product showcase,
 *   why-us, FAQ, and CTA. Prices removed; product value shown without amounts.
 * @status Stable.
 * @issues None.
 * @todo None.
 */
...
type WD = ReturnType<typeof useLocale>["t"]["webDesign"];
...
function WebDesignHero({ wd }: { wd: WD }) {
  return (
...
function ProductsSection({ wd }: { wd: WD }) {
  const products = [
