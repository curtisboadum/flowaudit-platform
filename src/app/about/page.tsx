...
const teamMembers = [
  {
    ...
    description:
      "Systems thinker and AI Systems Architect. Builds the AI infrastructure powering every FlowAudit assistant. Designs the architecture, commands the agent swarms, and runs the technical vision.",
    initials: "CB",
        ...
        <section className="border-b border-[rgba(55,50,47,0.12)] px-4 py-16 sm:px-6 sm:py-20 lg:px-0">
          <div className="mx-auto max-w-[700px]">
            ...
            <p className="mt-4 font-sans text-base leading-7 text-[#605A57]">
              ...
              quoting, the invoicing, the follow-ups, the scheduling. We build systems to handle
              all of it, so you focus on the work paying your bills.
            </p>
          </div>
        </section>
