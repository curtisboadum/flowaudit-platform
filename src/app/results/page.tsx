...
export const metadata: Metadata = {
  title: "Results — FlowAudit_ Case Studies",
  description:
    "Proven results across multiple industries. See how teams save 20+ hours per week with FlowAudit_.",
  alternates: {
    canonical: "/results",
  },
};
...
const testimonials = [
  ...
  {
    quote:
      "We tried three different CRMs before realizing the problem wasn't the tool — it was the manual work. FlowAudit_ solved the actual problem.",
    name: "Sarah Chen",
